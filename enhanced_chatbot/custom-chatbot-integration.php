...
// Enqueue the enhanced styles and scripts
add_action('admin_enqueue_scripts', function() {
    wp_enqueue_style('enhanced-chatbot-admin', plugin_dir_url(__FILE__) . 'admin.css');
    wp_enqueue_script('enhanced-chatbot-admin', plugin_dir_url(__FILE__) . 'admin.js', array('jquery'), null, true);
});
