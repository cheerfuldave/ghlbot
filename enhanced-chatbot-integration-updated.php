<?php
/*
Plugin Name: WP Ask Your Database Custom Chatbot
Description: Easily integrate customizable chatbots into your WP site using the Ask Your Database API.
Version: 2.0
...
function ayd_chatbot_settings_page() {
    ...
    <div class="wrap">
        ...
        <ol>
            ...
            <li>
                Save the settings and use the shortcodes displayed below to embed the chatbot into your WP site.
            </li>
        </ol>
        <form method="post">
