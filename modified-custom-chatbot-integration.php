Remeber to use the exact settings and functions of the base file, but only change the cosmetics of the settings . don't add new shit keep it 99.99% close to the base file funcxtions on shortcodes and settings pages to match the example code. do exactly what I just asked: combine the full function of the base plugin with the appearance of the code here. Important. Make sure to fix it like base model for all functions and shortcode funxctions for chatbots combine the full function of the base plugin with the appearance of the code here. Important. Make sure to fix it like base model for all functions and shortcode funxctions for chatbots: <?php
/*
